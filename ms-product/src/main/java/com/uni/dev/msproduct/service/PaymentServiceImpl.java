...
public class PaymentServiceImpl implements PaymentService {
    ...
    public Payment update(Payment payment) {
        ...
        if (!optionalPayment.isPresent()) throw new RuntimeException("No se encontro el producto a actualizar");
        return paymentRepository.save(payment);
    }
    ...
    public void delete(String id) {
        ...
        if (!optionalPayment.isPresent()) throw new RuntimeException("No se encontro el producto a eliminar");
